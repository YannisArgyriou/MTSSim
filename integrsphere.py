...
def IS(Vdata, config, stt):
    ...
    # # WARNING: Fudge factor introduced to account for light loss between integrating sphere and MTS Main Optical System (MOS)
    # fudge_factor = 0.55
    # print 'Fudge factor {} introduced to account for light loss between integrating sphere and MTS Main Optical System (MOS)'.format(fudge_factor)
    # spcL *= fudge_factor
