...
MOSTransn = 'MOScurve_capture_shift_blue0.06.txt' # CHANGED from  MOStransmit.dat (as used in MTSSim v2.6.1 of Ruyman Azzollini)
...
'T_OBA':T_OBA, 'theta_OBA':theta_OBA, 'OBAFctr': OBAFctr,\
